      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              <li>📍 Ground Floor, JKS Complex, Anjaneya Temple, Main Bazar,
Hosapete – 583 201</li>
              <li>📞 +91 8861016415</li>
              <li>📱 +91 8861016415</li>
              <li>✉ vikasshikshana@gmail.com</li>
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col md:flex-row justify-between items-center gap-2 text-xs text-slate-500">
          <p>© 2026 Vikas Shikshana Souharda Sahakari Ni.. All rights reserved.</p>
          <p>Registered under Karnataka Souharda Sahakari Act, 1997 | Reg. No. VJN-0003</p>
        </div>
      </div>
    </footer>
  );
