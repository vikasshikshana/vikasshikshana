...
const boardMembers = [
  {
    name: "Sri Ramesh B. Naidu",
    role: "President",
    designation: "Retired Principal, Govt. High School",
    since: "Elected 2022",
    bio: "A retired government school principal with 32 years of experience in primary and secondary education. Sri Naidu has been a member since 2005 and has led the society as President since 2022, driving our expansion to 45 villages.",
    committees: ["Education & Scholarship Committee (Chair)", "Program & Events Committee"],
    initials: "RN",
  },
  {
    name: "Smt. Lakshmi Devi K.",
    role: "Vice President",
    designation: "Lecturer, Government First Grade College",
    since: "Elected 2022",
    bio: "A highly respected commerce lecturer, Smt. Lakshmi Devi brings 25 years of academic expertise to the board. She championed our vocational training program and leads our women's education initiatives.",
    committees: ["Finance & Audit Committee (Chair)", "Member Welfare Committee"],
    initials: "LK",
  },
  {
    name: "Sri Manjunath S. Gowda",
    role: "Secretary",
    designation: "Retired District Education Officer",
    since: "Elected 2020",
    bio: "A former District Education Officer who oversaw government school administration across Bengaluru Rural district. Sri Gowda manages our day-to-day administration, correspondence, and regulatory filings with exceptional expertise.",
    committees: ["Program & Events Committee (Chair)", "Education & Scholarship Committee"],
    initials: "MG",
  },
  {
    name: "Sri Vijayakumar R. Shetty",
    role: "Treasurer",
    designation: "Chartered Accountant",
    since: "Elected 2022",
    bio: "A practicing Chartered Accountant with 20 years of experience in cooperative finance and audit. Sri Shetty ensures our financial management meets the highest standards of transparency and accountability.",
    committees: ["Finance & Audit Committee", "Building & Infrastructure Committee (Chair)"],
    initials: "VS",
  },
  {
    name: "Smt. Padmavathi H. Rao",
    role: "Director",
    designation: "Headmistress, Kannada Medium School",
    since: "Elected 2022",
  ...
  {
    name: "Sri Basavaraja N. Patil",
    role: "Director",
    designation: "Agriculture Officer (Retd.)",
    since: "Elected 2022",
    bio: "A retired Agriculture Officer representing our rural member base. Sri Patil has been instrumental in expanding our programs to agricultural communities and establishing our Tumkur branch.",
    committees: ["Program & Events Committee", "Building & Infrastructure Committee"],
    initials: "BP",
  },
  {
    name: "Smt. Sumitra G. Joshi",
    role: "Director",
  ...
  {
    name: "Sri Pradeep K. Acharya",
    role: "Director",
    designation: "IT Professional & Community Leader",
    since: "Elected 2022",
    bio: "A senior IT professional who donated the initial 50 computers for our digital literacy center. Sri Pradeep spearheads our digital transformation and e-learning initiatives.",
    committees: ["Program & Events Committee", "Building & Infrastructure Committee"],
    initials: "PA",
  },
  {
    name: "Smt. Anitha R. Murthy",
    role: "Director",
...
const committees = [
  {
    ...
    chair: "Sri Ramesh B. Naidu (President)",
  ...
  },
  {
    ...
    chair: "Sri Manjunath S. Gowda (Secretary)",
    members: "4 directors",
  ...
  },
  {
    ...
    chair: "Sri Vijayakumar R. Shetty (Treasurer)",
    members: "3 directors",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto text-center">
            <div className="bg-emerald-900 text-white rounded-2xl p-8">
              ...
              <p className="text-emerald-200 text-sm leading-relaxed">
                All 2,500+ members form the supreme governing authority. Meets annually (AGBM) before 30 September.
                Elects the board and approves major decisions.
              </p>
            </div>
            ...
            <div className="bg-amber-50 border-2 border-amber-400 rounded-2xl p-8">
              ...
              <p className="text-slate-600 text-sm leading-relaxed">
                9 elected directors manage day-to-day affairs. Elected by the General Body for a 5-year term.
      ...
      <section className="py-12 md:py-20 bg-stone-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-slate-500 text-sm mt-2">Elected at the 2022 Annual General Body Meeting | Term: 2022–2027</p>
          </div>
